...
INSERT INTO car(plate, year_of_production, km, potentional_engine_issue, owner_id, model_id, is_electric) VALUES('ABC123', 2020, 15000, 0, 1, 1, 1);
...
INSERT INTO car(plate, year_of_production, km, potentional_engine_issue, owner_id, model_id, is_electric) VALUES('MAA123', 2020, 15000, 0, 1, 1, 1);
INSERT INTO car(plate, year_of_production, km, potentional_engine_issue, owner_id, model_id, is_electric) VALUES('GAS', 2020, 15000, 0, 1, 1, 0);
