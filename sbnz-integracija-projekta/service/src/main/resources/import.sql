...
INSERT INTO car(plate, year_of_production, km, potentional_engine_issue, owner_id, model_id, is_electric, rule_finished) VALUES('ABC123', 2020, 15000, 0, 1, 1, 1, 0);


INSERT INTO battery(nominal_max_charge, nominal_max_voltage) VALUES(72.0, 5.0);
INSERT INTO electric_car (id, potentional_battery_problem, percentage_battery, fault_check, battery_id) VALUES(1, 0, 80, 0, 1);


INSERT INTO car(plate, year_of_production, km, potentional_engine_issue, owner_id, model_id, is_electric, rule_finished) VALUES('MAA123', 2020, 15000, 0, 1, 1, 1, 0);
INSERT INTO car(plate, year_of_production, km, potentional_engine_issue, owner_id, model_id, is_electric, rule_finished) VALUES('GAS', 2020, 15000, 0, 1, 1, 0, 0);

INSERT INTO battery(nominal_max_charge, nominal_max_voltage) VALUES(50.0, 5.0);
INSERT INTO electric_car (id, potentional_battery_problem, percentage_battery, fault_check, battery_id) VALUES(2, 0, 80, 0, 2);
INSERT INTO gas_car (id, potentional_turbine_issue, potentional_cooling_leakage) VALUES (3, 0, 0)
